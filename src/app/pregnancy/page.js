        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="text-lg md:text-xl text-gray-700 leading-relaxed space-y-6">
              <p>
                צילומי הריון הם דרך מיוחדת לתעד את התקופה היפה והמיוחדת בחייכם. 
                אני מתמחה בצילום הריון שמתמקד ביופי הטבעי ובאינטימיות של הרגע הזה.
              </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              דוגמאות לצילומי הריון יפים ואינטימיים
            </p>
          </motion.div>
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 text-lg leading-relaxed font-medium max-w-2xl mx-auto">
                צילום הריון יפה ואינטימי שמתעד את התקופה המיוחדת בחייכם.
              </p>
            </div>
